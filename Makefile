...
KERNEL_FILES = $(addprefix Kernel/, Kernel VGA/VGA Memory/MemoryManager Memory/PagingStructureEntry Memory/MemoryRegion Memory/PhysicalMemory Memory/PageDirectory Memory/PageTable)
